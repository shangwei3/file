#ifndef __DRIVER_AP3216C_H
#define __DRIVER_AP3216C_H
...
extern void AP3216_ReadDataTest(void);
extern uint8_t AP3216_WriteOneByte(uint8_t reg, uint8_t data);
extern uint8_t AP3216_ReadOneByte(uint8_t reg);
extern void AP3216_Read_IR_Data(uint16_t *pIR);
extern void AP3216_Read_PS_Data(uint16_t *pPS);
extern void AP3216_Read_ALS_Data(uint16_t *pALS);
#endif
